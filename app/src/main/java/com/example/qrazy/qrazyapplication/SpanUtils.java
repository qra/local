...
//        }
     ...
     * 去除下划线的可点击Span
     */
    public static class ClickableNoUnderLineSpan extends ClickableSpan {
        ...
        public ClickableNoUnderLineSpan(int textColor) {
            super();
        ...
        public void updateDrawState(TextPaint ds) {
            ds.setColor(mTextColor == 0 ? ds.linkColor : mTextColor);

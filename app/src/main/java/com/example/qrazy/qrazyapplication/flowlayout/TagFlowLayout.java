...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    public interface OnTagClickListener {
        boolean onTagClick(View view, boolean isChecked, int position, FlowLayout parent);
    }
    ...
    public boolean performClick() {
        ...
        if (child != null) {
            ...
            if (mOnTagClickListener != null) {
                return mOnTagClickListener.onTagClick(child.getTagView(), child.isChecked(),pos, this);
            }
        }
        return true;
    }
